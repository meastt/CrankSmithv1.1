...
export const componentDatabase = {
  cranksets: [
    ...
    { id: "shimano-grx-rx820-1x-40", model: "Shimano GRX RX820 1x", variant: 655, weight: "40T", bikeType: "gravel", teeth: [40"], speeds: "12-speed" },
    ...
    { id: "fsa-slk-light-50-34", model: "FSA SL-K Light", variant: "50/34T", weight: 619, bikeType: "road
