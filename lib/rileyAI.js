...
processAffiliateLinks(response) {
  // Add the buttons HTML at the end of Riley's response
  const buttonsHtml = `
    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mt-6">
      <a href="https://www.jensonusa.com/?utm_source=cranksmith&utm_medium=CrankSmith.com" 
         target="_blank"
         class="px-6 py-3 rounded-xl font-medium transition-all text-base min-w-[200px] flex items-center justify-center gap-2"
      ...
      <a href="https://www.competitivecyclist.com/?utm_source=cranksmith&utm_medium=CrankSmith" 
         target="_blank"
         class="px-6 py-3 rounded-xl font-medium transition-all text-base min-w-[200px] flex items-center justify-center gap-2"
         style="background: var(--surface-elevated); color: var(--text-primary); border: 1px solid var(--border-subtle);">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
