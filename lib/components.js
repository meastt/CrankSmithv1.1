...
export const componentDatabase = {
  cranksets: [
    ...
    { id: "shimano-xtr-m9200-30", model: "Shimano XTR M9200 Di2", variant: "30T XC", weight: 570, bikeType: "mtb", teeth: [30], speeds: "12-speed wireless" },
    { id: "shimano-xtr-m9200-32", model: "Shimano XTR M9200 Di2", variant: "32T XC", weight: 570, bikeType: "mtb", teeth: [32], speeds: "12-speed wireless" },
    { id: "shimano-xtr-m9200-34", model: "Shimano XTR M9200 Di2", variant: "34T XC", weight: 570, bikeType: "mtb", teeth: [34], speeds: "12-speed wireless" },
    { id: "shimano-xtr-m9200-trail-32", model: "Shimano XTR M9220 Di2", variant: "32T Trail", weight: 587, bikeType: "mtb", teeth: [32], speeds: "12-speed wireless" },
    { id: "shimano-xtr-m9200-trail-34", model: "Shimano XTR M9220 Di2", variant: "34T Trail", weight: 587, bikeType: "mtb", teeth: [34], speeds: "12-speed wireless" },
...
export const getComponentsForBikeType = (bikeType) => {
  return {
    cranksets: componentDatabase.cranksets.filter(c => {
      // Allow MTB components for gravel bikes and vice versa
      if (bikeType === 'gravel') {
        return c.bikeType === 'gravel' || c.bikeType === 'mtb';
      }
      if (bikeType === 'mtb') {
        return c.bikeType === 'mtb' || c.bikeType === 'gravel';
      }
      return c.bikeType === bikeType;
    }),
    cassettes: componentDatabase.cassettes.filter(c => {
      // Allow MTB components for gravel bikes and vice versa
      if (bikeType === 'gravel') {
        return c.bikeType === 'gravel' || c.bikeType === 'mtb';
      }
