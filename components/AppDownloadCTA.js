    ...
    <section className="app-download-cta py-16" style={{
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2" style={{ color: 'var(--text-primary)' }}> {/* FIXED: Changed text-white to var(--text-primary) for contrast */}
                    Mobile App
                  </h3>
            ...
            <div className="card">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2" style={{ color: 'var(--text-primary)' }}> {/* FIXED: Changed text-white to var(--text-primary) */}
                    Offline Access
                  </h3>
                  <p style={{ color: 'var(--text-secondary)' }}>
          ...
          <div className="text-center">
            <div style={{
              ...
              <h3 className="text-2xl font-bold mb-4" style={{ color: 'var(--text-inverse)' }}> {/* FIXED: Used --text-inverse (white in light, dark in dark) for better adaptability */}
                Download CrankSmith
              </h3>
              ...
              {showInstallButton ? (
                <button
                  ...
                  style={{
                    background: 'rgba(255, 255, 255, 0.2)',
                    color: 'var(--text-inverse)', // FIXED: Changed 'white' to var(--text-inverse)
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-semibold mb-8" style={{ color: 'var(--text-primary)' }}> {/* FIXED: Changed text-white to var(--text-primary) */}
            What Cyclists Say
          </h3>
