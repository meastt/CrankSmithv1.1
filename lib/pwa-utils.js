...
// PWA install detection hook (must be used inside React component)
// Note: This is a React hook and must be imported with { useState, useEffect } from 'react'
export const useInstallPrompt = () => {
  if (typeof window === 'undefined') return null;

  // This should only be used in components, not here
  // Return the deferred prompt that's managed globally instead
