  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-white transition-colors duration-300">
      ...
      >
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative">
                ...
                <div className="relative w-12 h-12 bg-gradient-performance rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link 
                ...
                className="p-2 rounded-xl text-neutral-600 dark:text-neutral-300 hover:text-brand-blue transition-colors"
              >
        ...
        } overflow-hidden bg-white/95 dark:bg-neutral-950/95 backdrop-blur-premium border-t border-neutral-200 dark:border-neutral-800`}>
        ...
        <div className="container-responsive">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-8 bg-gradient-performance rounded-lg flex items-center justify-center">
              ...
              <nav className="space-y-2">
                {navLinks.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className="block text-sm text-neutral-600 dark:text-neutral-400 hover:text-brand-blue transition-colors"
                  >
                    {link.label}
                  </Link>
                ))}
          ...
          <div className="border-t border-neutral-200 dark:border-neutral-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center gap-4 mt-4 md:mt-0">
              <Link href="/docs" className="text-xs text-neutral-500 dark:text-neutral-400 hover:text-brand-blue transition-colors">
                Docs
              </Link>
              <Link href="/blog" className="text-xs text-neutral-500 dark:text-neutral-400 hover:text-brand-blue transition-colors">
                Blog
              </Link>
            </div>
          </div>
