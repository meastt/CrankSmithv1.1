        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled 
            ? mounted 
              ...
              : 'bg-white/80 backdrop-blur-premium border-b border-neutral-200'
            : 'bg-transparent'
        }`}
      >
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative">
                ...
                <div className={`relative w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg p-1 ${
                  mounted ? 'bg-white dark:bg-neutral-800' : 'bg-white'
                }`}>
                  <Image 
              ...
              <div className="flex flex-col">
                ...
                <span className={`text-xs font-medium ${
                  mounted ? 'text-neutral-500 dark:text-neutral-400' : 'text-neutral-500'
                }`}>
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link 
                ...
                className={`p-2 rounded-xl hover:text-brand-blue transition-colors ${
                  mounted ? 'text-neutral-600 dark:text-neutral-300' : 'text-neutral-600'
                }`}
              >
        ...
        <div className={`md:hidden transition-all duration-300 ease-out-expo ${
        ...
        } overflow-hidden backdrop-blur-premium border-t ${
          mounted 
            ? 'bg-white/95 dark:bg-neutral-950/95 border-neutral-200 dark:border-neutral-800'
          ...
          <nav className="container-responsive py-6">
            ...
            <div className={`flex items-center justify-between mt-6 pt-6 border-t ${
              mounted ? 'border-neutral-200 dark:border-neutral-800' : 'border-neutral-200'
            }`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className={`text-sm leading-relaxed ${
                mounted ? 'text-neutral-600 dark:text-neutral-400' : 'text-neutral-600'
              }`}>
            ...
            <div>
              <h3 className={`font-semibold mb-4 ${
                mounted ? 'text-neutral-900 dark:text-white' : 'text-neutral-900'
              }`}>Tools</h3>
