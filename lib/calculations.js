...
export function compareSetups(currentSetup, proposedSetup, speedUnit = 'KMH') {
  ...
  // Calculate gear ranges (cassette range as percentage)
  ...
  const proposedGearRange = ((proposedSetup.cassette.teeth[proposedSetup.cassette.teeth.length - 1] / proposedSetup.cassette.teeth[0]) * 100).toFixed(0)
